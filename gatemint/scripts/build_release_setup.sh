...
if [ ! -d "${GOPATH}/src/github.com/gatechain/gatemint/.git" ]; then
...
gpg --import ${GOPATH}/src/github.com/gatechain/gatemint/installer/rpm/RPM-GPG-KEY-Algorand

# Install latest Go
cd $HOME
# TODO: make a config file in root of repo with single source of truth for Go major-minor version
if [ ! -e /usr/local/go/bin/go ]; then
    python3 ${GOPATH}/src/github.com/gatechain/gatemint/scripts/get_latest_go.py --version-prefix=1.12
