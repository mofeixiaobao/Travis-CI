go get github.com/gatechain/crypto

cd ~/go/src/github.com/gatechain/crypto

make install

cd ~/go/src/github.com/gatechain

git clone https://github.com/gatechain/gatemint.git
