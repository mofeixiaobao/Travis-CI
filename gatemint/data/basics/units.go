...
func (a Power) LessThan(b Power) bool {
	return a.Raw < b.Raw
}

// GreaterThan implements arithmetic comparison for Power
func (a Power) GreaterThan(b Power) bool {
	return a.Raw > b.Raw
}

// IsZero implements arithmetic comparison for Power
func (a Power) IsZero() bool {
	return a.Raw == 0
}

// ToUint64 converts the amount of algos to uint64
func (a Power) ToUint64() uint64 {
	return a.Raw
}

// RewardUnits returns the number of reward units in some number of algos
func (a Power) RewardUnits(proto config.ConsensusParams) uint64 {
	return a.Raw / proto.RewardUnit
}

// CodecEncodeSelf implements codec.Selfer to encode Power as a simple int
func (a Power) CodecEncodeSelf(enc *codec.Encoder) {
	enc.MustEncode(a.Raw)
}

// CodecDecodeSelf implements codec.Selfer to decode Power as a simple int
func (a *Power) CodecDecodeSelf(dec *codec.Decoder) {
...
func OneTimeIDForRound(round Round, keyDilution uint64) OneTimeSignatureIdentifier {
...
func RefreshPartRound(round Round, keyDilution uint64) (endRound uint64) {
	return uint64(round) + config.GetDefaultLocal().RefreshPartInterval*keyDilution
}
