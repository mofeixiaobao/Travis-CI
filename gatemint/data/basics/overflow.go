...
// OAddA adds 2 Power values with overflow tracking
func OAddA(a Power, b Power) (res Power, overflowed bool) {
	res.Raw, overflowed = OAdd(a.Raw, b.Raw)
	return
}

// OSubA subtracts b from a with overflow tracking
func OSubA(a Power, b Power) (res Power, overflowed bool) {
	res.Raw, overflowed = OSub(a.Raw, b.Raw)
	return
}

// MulAIntSaturate uses MulSaturate to multiply b (int) with a (Power)
func MulAIntSaturate(a Power, b int) Power {
	return Power{Raw: MulSaturate(a.Raw, uint64(b))}
}

// AddA adds 2 Power values with overflow tracking
func (t *OverflowTracker) AddA(a Power, b Power) Power {
	return Power{Raw: t.Add(uint64(a.Raw), uint64(b.Raw))}
}

// SubA subtracts b from a with overflow tracking
func (t *OverflowTracker) SubA(a Power, b Power) Power {
	return Power{Raw: t.Sub(uint64(a.Raw), uint64(b.Raw))}
}
...
func (t *OverflowTracker) ScalarMulA(a Power, b uint64) Power {
	return Power{Raw: t.Mul(a.Raw, b)}
}
