...
var readOnlyParticipationVotes = []*basics.OneTimeSignatureSecrets{}
...
func (v testBlockValidator) Validate(ctx context.Context, period uint64, e bookkeeping.Block) (agreement.ValidatedBlock, error) {
...
func (f testBlockFactory) AssembleBlock(r basics.Round, period uint64, deadline time.Time, committeeBottomPeriod uint64) (agreement.ValidatedBlock, error) {
...
func (l *testLedger) CertificateSave(certificateSave agreement.Certificate) {
	//l.CertificateSave(certificateSave)
}

func (l *testLedger) UnauthenticatedCertificateSave(certificateSave agreement.UnauthenticatedCertificate) {
	//l.CertificateSave(certificateSave)
}
