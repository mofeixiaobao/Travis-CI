...
func (t *demuxTester) CertificateSave(CertificateSave Certificate) {
	// we don't care about this function in this test.
	//do nothing
}

func (t *demuxTester) UnauthenticatedCertificateSave(certificateSave UnauthenticatedCertificate) {
