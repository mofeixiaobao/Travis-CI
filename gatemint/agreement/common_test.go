...
func (v testBlockValidator) Validate(ctx context.Context, period uint64, e bookkeeping.Block) (ValidatedBlock, error) {
...
func (f testBlockFactory) AssembleBlock(r basics.Round, period period, deadline time.Time) (ValidatedBlock, error) {
...
func (l *testLedger) CertificateSave(certificateSave Certificate) {
	//l.CertificateSave(certificateSave)
}

func (l *testLedger) UnauthenticatedCertificateSave(certificateSave UnauthenticatedCertificate) {
	//l.CertificateSave(certificateSave)
}
