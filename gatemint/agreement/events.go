...
type externalEvent interface {
	...
	// AttachConsensusVersion returns a copy of this externalEvent with
	// service zero time
	AttachZeroTime(t time.Time) externalEvent
}
...
const (
	...
	// committeeFrozen is sent between the player and proposal state machines
	// to specify that the proposal-vote with the lowest credential should
	// be fixed.
	committeeFrozen
)
...
func (e emptyEvent) AttachZeroTime(t time.Time) externalEvent {
	return e
}
...
func (e messageEvent) AttachZeroTime(t time.Time) externalEvent {
	e.zeroTime = t
	return e
}
...
func (e roundInterruptionEvent) AttachZeroTime(t time.Time) externalEvent {
	e.zeroTime = t
	return e
}
...
func (e timeoutEvent) AttachZeroTime(t time.Time) externalEvent {
	e.zeroTime = t
	return e
}
...
func (e proposalTimeoutEvent) t() eventType {
	return e.T
}

func (e proposalTimeoutEvent) String() string {
	return e.t().String()
}

func (e proposalTimeoutEvent) ComparableStr() string {
	return e.t().String()
}

func (e proposalTimeoutEvent) ConsensusRound() round {
	return e.Round
}

func (e proposalTimeoutEvent) AttachConsensusVersion(v ConsensusVersionView) externalEvent {
	e.Proto = v
	return e
}

func (e proposalTimeoutEvent) AttachZeroTime(t time.Time) externalEvent {
	e.zeroTime = t
	return e
}
...
type proposalSavedEvent struct {
	// Round and Period are the round in which the proposal was accepted.
	Round  round
	Period period
...
func (e proposalSavedEvent) t() eventType {
	return proposalSaved
}

func (e proposalSavedEvent) String() string {
	return fmt.Sprintf("%v: %.5v", e.t().String(), e.Proposal.BlockDigest.String())
}

func (e proposalSavedEvent) ComparableStr() string {
	return e.String()
}
...
type committeeFrozenEvent struct {
	// Proposal is set to be the proposal-value which was frozen.
	Proposal      proposalValue
	CommitteeVote voteMaxHeap
}

func (e committeeFrozenEvent) t() eventType {
	return committeeFrozen
}

func (e committeeFrozenEvent) String() string {
	return e.t().String()
}

func (e committeeFrozenEvent) ComparableStr() string {
	return e.String()
}
...
func (e checkpointEvent) AttachZeroTime(t time.Time) externalEvent {
	return e
}
