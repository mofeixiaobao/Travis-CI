...
func SendJSON(obj Response, w http.ResponseWriter, log logging.Logger) {
	...
	if err != nil {
		log.Warnf("gmd failed to write an object to the response stream: %v", err)
	}
}
...
type BroadcastResponse struct {
	// in: body
	Body *v1.ResultBroadcastTx
}

func (t BroadcastResponse) getBody() interface{} {
	return t.Body
}
...
type TxResponse struct {
	// in: body
	Body *appinterface.ResponseTx
}

func (t TxResponse) getBody() interface{} {
	return t.Body
}

type GenParticipationKeyResponse struct {
	Body *v1.ParticipationKeyResponse
}

func (t GenParticipationKeyResponse) getBody() interface{} {
	return t.Body
}

type GetParticipationKeyResponse struct {
	Body *v1.ParticipationKeyResponse
}

func (t GetParticipationKeyResponse) getBody() interface{} {
	return t.Body
}

type GetConAccountResponse struct {
	Body *v1.ResultConAccount
}

func (t GetConAccountResponse) getBody() interface{} {
	return t.Body
}

type GetLocalConAccountsResponse struct {
	Body *[]appinterface.ParticipationData
}

func (t GetLocalConAccountsResponse) getBody() interface{} {
	return t.Body
}

type CheckConAcctsResponse struct {
	Body *string
}

func (t CheckConAcctsResponse) getBody() interface{} {
	return t.Body
}
...
func (t StringArrayResponse) getBody() interface{} {
	return t.Body
}

type TxSearchRes struct {
	Body *appinterface.ResultTxSearch
}

func (t TxSearchRes) getBody() interface{} {
	return t.Body
}
