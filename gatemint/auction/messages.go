...
func (d Deposit) ToBeHashed() (crypto.HashID, []byte) {
...
// ToBeHashed implements the crypto.Hashable interface.
func (b Bid) ToBeHashed() (crypto.HashID, []byte) {
...
// ToBeHashed implements the crypto.Hashable interface.
func (o BidOutcomes) ToBeHashed() (crypto.HashID, []byte) {
...
// ToBeHashed implements the crypto.Hashable interface.
func (s Settlement) ToBeHashed() (crypto.HashID, []byte) {
...
// ToBeHashed implements the crypto.Hashable interface.
func (p Params) ToBeHashed() (crypto.HashID, []byte) {
