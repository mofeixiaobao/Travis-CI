...
import (
	...
	"github.com/gatechain/gatemint/netdeploy"
...
var networkCmd = &cobra.Command{
	...
	Long: `Collection of commands to support the creation and management of 'private networks'. These are fully-formed gatemint networks with private, custom Genesis ledgers running the current build of gatechain software. Rather than creating a node instance based on the released genesis.json, these networks have their own and need to be manually connected.
